...
function Header() {
  return (
    <div className='h-48 md:h-64 bg-blue-900 relative text-center flex flex-col justify-center items-center'>
      <p className='font-bold text-3xl md:text-6xl text-white animate-fadeIn'>Announcement</p>
      <p className='font-bold text-2xl md:text-4xl text-white mt-2 md:mt-4 animate-fadeIn'>
        Announcement | <a href='/' className='text-blue-900 hover:text-blue-500 transition-colors duration-300'><span>Home</span></a>
      </p>
